(function () {
  ...
  style.textContent =
    ...
    ".el-nudge{position:absolute;bottom:70px;display:none;width:238px;grid-template-columns:minmax(0,1fr) auto;align-items:start;overflow:visible;color:#26312b;background:#fff;border:1px solid #d6e2d1;border-radius:14px;box-shadow:0 14px 34px rgba(38,58,47,.16)}" +
    ...
    ".el-nudge::after{position:absolute;bottom:-7px;width:13px;height:13px;content:'';background:#fff;border-right:1px solid #d6e2d1;border-bottom:1px solid #d6e2d1;transform:rotate(45deg)}" +
    ...
    ":host([data-theme=dark]) .el-nudge,[data-elachee-chatbot][data-theme=dark] .el-nudge{color:#f1f5ee;background:#26382b;border-color:#415740}:host([data-theme=dark]) .el-nudge::after,[data-elachee-chatbot][data-theme=dark] .el-nudge::after{background:#26382b;border-color:#415740}:host([data-theme=dark]) .el-nudge-action small,:host([data-theme=dark]) .el-nudge-close,[data-elachee-chatbot][data-theme=dark] .el-nudge-action small,[data-elachee-chatbot][data-theme=dark] .el-nudge-close{color:#c7d3c3}" +
    ".el-panel{position:relative;display:none;width:min(390px,calc(100vw - 28px));height:min(650px,calc(100vh - 90px));margin-bottom:12px;overflow:hidden;background:#fff;border:1px solid rgba(63,117,73,.14);border-radius:20px;box-shadow:0 28px 80px rgba(38,58,47,.24)}" +
    ...
    ".el-close{position:absolute;z-index:2;top:10px;display:grid;width:34px;height:34px;place-items:center;padding:0;color:#fff;background:#263a2f;border:1px solid rgba(255,255,255,.18);border-radius:9px;cursor:pointer;box-shadow:0 4px 14px rgba(38,58,47,.18)}" +
    ...
    "@media(prefers-color-scheme:dark){:host([data-theme=auto]) .el-nudge,[data-elachee-chatbot][data-theme=auto] .el-nudge{color:#f1f5ee;background:#26382b;border-color:#415740}:host([data-theme=auto]) .el-nudge::after,[data-elachee-chatbot][data-theme=auto] .el-nudge::after{background:#26382b;border-color:#415740}:host([data-theme=auto]) .el-nudge-action small,:host([data-theme=auto]) .el-nudge-close,[data-elachee-chatbot][data-theme=auto] .el-nudge-action small,[data-elachee-chatbot][data-theme=auto] .el-nudge-close{color:#c7d3c3}}" +
